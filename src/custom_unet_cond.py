...
#from src.attention import SpatialTransformer
...
"""
This model was adapted from https://github.com/BioMedAI-UCSC/InverseSR/blob/main/models/unet_v2_conditioned.py
"InverseSR: 3D Brain MRI Super-Resolution Using a Latent Diffusion Model"
It is strongly based on https://github.com/CompVis/latent-diffusion/blob/main/ldm/modules/diffusionmodules/model.py 
"""
...
class UNetModel(ModelMixin, ConfigMixin):
    def __init__(
        ...
        config = {"_class_name": "UNetModel", "_diffusers_version": diffusers.__version__,
            "image_size": self.image_size, "in_channels": self.in_channels, "model_channels": self.model_channels,
            "out_channels": self.out_channels,  "num_res_blocks": self.num_res_blocks, "attention_resolutions": self.attention_resolutions,
            "dropout": self.dropout, "channel_mult": self.channel_mult, "conv_resample": self.conv_resample, "num_classes": self.num_classes,
            ...
            "use_spatial_transformer": use_spatial_transformer, "transformer_depth": transformer_depth, "context_dim": context_dim,
            "n_embed": n_embed
            }
        self.config_ = config
    ...
    def setup_config(self):
        config = {"_class_name": "UNetModel", "_diffusers_version": diffusers.__version__,
            ...
            "use_spatial_transformer": self.use_spatial_transformer, "transformer_depth": self.transformer_depth, "context_dim": self.context_dim,
